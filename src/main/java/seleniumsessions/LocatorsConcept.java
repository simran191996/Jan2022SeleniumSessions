...
public class LocatorsConcept {
	//static as we dont need to create obj ..and define at class level so that we can use in functions
...
//		eleUtil.doSendKeys(password, "test@123");
	...
	//creating By Locator
	//static-dont need to create obj
	//give String loc value+type of that locator(id,etc)
	//to create locators in Selenium-By Class
	//locator type -By hence return type By
	...
	//getElement method --for creating WEbElement
